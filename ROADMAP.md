...
## **2026-04-14 v1.4.0 - Мобільна Платформа та Сервісний Асистент**
- **Додано:** Розгортання мобільного ядра на Expo SDK 52.
- **Додано:** Система розумних нагадувань на основі пробігу (Oil, Gearbox, Diff).
- **Додано:** Повнофункціональне редагування профілю та керування гаражем у мобільному додатку.
- **Оновлено:** Універсальний скрипт запуску `start.sh` — тепер піднімає весь стек (Web + Mobile).
